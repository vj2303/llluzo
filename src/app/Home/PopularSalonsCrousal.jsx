    ...
    const salons = [
        {
            name: 'BBlunt',
            href: '/salon/BBLUNT',
            imgSrc: '/logos_salons/BBlunt.jpg'
        },
        {
            name: 'bodycraft',
            href: '/salon/Bodycraft',
            imgSrc: '/logos_salons/Bodycraft.png'
        },
        {
            name: 'Looks Salon',
            href: '/salon/Looks',
            imgSrc: '/logos_salons/Looks.jpg'
        },
        {
            name: 'Enrich',
            href: '/salon/#',
            imgSrc: '/logos_salons/enrich-logo-1.png'
        },
        {
            name: 'Toni & Guy',
        ...
        },
        {
            ...
            imgSrc: '/logos_salons/jcb_updated.png'
        },
        // {
        ...
        // },
        {
            ...
            imgSrc: '/logos_salons/hair_master_logo-removebg-preview.png'
        },
        {
            name: 'Femina and Flaunt',
            href: '/salon/Femina Flaunt',
            imgSrc: '/logos_salons/Femina_Flaunt.png'
        },
        {
            name: 'Elixir',
            href: '/salon/Elixir Wellness',
            imgSrc: '/logos_salons/Elixir_Wellness.png'
        },
        {
            name: 'Dessange Paris',
        ...
        },
        {
            ...
            imgSrc: '/logos_salons/nailashes_updated.png'
        },
        {
            name: 'Affinity Elite',
            href: '/salon/Affinity Elite',
            imgSrc: '/logos_salons/affinity_updated.png'
        },

        {
            name: 'Lookwell',
            href: '/salon/LookWell',
            imgSrc: '/logos_salons/lookwell.png'
        },
        ...
        },
        {
            name: 'Kapils Salon ',
            href: '/salon/Kapils',
            imgSrc: '/logos_salons/kapils-salon-and-academy-pune-logo.png'
        },
        {
            name: 'Monsoon Salon',
        ...
        },
        {
            name: 'Juice',
            href: '/salon/juice',
            imgSrc: '/logos_salons/Juice_updated.png'
        },
        {
            name: 'Aveda x Nykaa',
            href: '/salon/Aveda x Nykaa',
            imgSrc: '/logos_salons/Aveda_Nykaa.png'
        },
        {
            name: 'Naturals Salon',
            href: '/salon/Naturals Salon',
            imgSrc: '/logos_salons/naturals.jpg'
        },
        {
            name: 'Apple',
            href: '/salon/Apple The Original',
            imgSrc: '/logos_salons/apple_updated2.png'
        },
    ];
